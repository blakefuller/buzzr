...
function SetupScreen(props) {
   ...
   <View style={styles.waitTimeContianer}>
      <Text style={styles.waitTimeText}>Your estimated wait time is {waitTime} minutes.</Text>
   </View> : null
      ...
      <View style={styles.screen}>
         <View style={styles.headerArea}>
            <TouchableOpacity style={styles.backButtonContainer} onPress={() => props.navigation.goBack()}>
               <Ionicons name='ios-arrow-back' size={20* scaleMultiplier} color={colors.onSecondary}/>
